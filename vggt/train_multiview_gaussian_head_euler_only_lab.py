...
iterations = 30000
N_OF_IMAGES_IN_ONE_STEP_EVAL = 20
MAX_IMAGES = 40
...
model.gs_head_feats.load_state_dict(torch.load("multiview_last_gs_head_feats_step.pth"))
...
# used_image_count = len(chosen_dataset.train_split)
used_image_count = 2
