...
from instantsplat.utils.system_utils import searchForMaxIteration
...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, opt=None, shuffle=False, resolution_scales=[1.0]):
        """b
