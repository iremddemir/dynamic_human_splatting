...
import torch
import numpy as np
from instantsplat.utils.general_utils import inverse_sigmoid, get_expon_lr_func, build_rotation
from torch import nn
import os
from instantsplat.utils.system_utils import mkdir_p
from plyfile import PlyData, PlyElement
from instantsplat.utils.sh_utils import RGB2SH
from simple_knn._C import distCUDA2
from instantsplat.utils.graphics_utils import BasicPointCloud
from instantsplat.utils.general_utils import strip_symmetric, build_scaling_rotation
from scipy.spatial.transform import Rotation as R
from instantsplat.utils.pose_utils import rotation2quad, get_tensor_from_camera
from instantsplat.utils.graphics_utils import getWorld2View2
from instantsplat.scene.per_point_adam import PerPointAdam


class GaussianModel_Without_Act:
    ...
    def setup_functions(self):
        ...
        identity = lambda x: x
        self.scaling_activation = identity
        self.scaling_inverse_activation = identity

        self.covariance_activation = build_covariance_from_scaling_rotation

        self.opacity_activation = identity
        self.inverse_opacity_activation = identity

        self.rotation_activation = identity
